...
# CONNECT TO DB
app.config["SQLALCHEMY_DATABASE_URI"] = os.environ.get("DATABASE_URL", "sqlite://blg.db")
...
def show_post(post_id):
    ...
    return render_template(
        ...
        user=current_user, form=comment_form, comments=comments
    )
...
def add_new_post():
    ...
    if post_form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for("get_all_posts"))
    return render_template("make-post.html", form=post_form, logged_in=current_user.is_authenticated, user=current_user)
...
def edit_post(post_id):
    ...
    return render_template(
        "make-post.html", is_edit=True, form=edit_form, logged_in=current_user.is_authenticated,
        user=current_user
    )
